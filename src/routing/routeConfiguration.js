...
const SearchPageGoogleMaps = loadable(() => import(/* webpackChunkName: "SearchPageGoogleMaps" */ /* webpackPrefetch: true */  '../containers/SearchPage/SearchPageGoogleMap'));
...
const routeConfiguration = () => {
  return [
    ...
    {
      path: '/sg',
      name: 'SearchPageGoogleMaps',
      component: SearchPageGoogleMaps,
      loadData: pageDataLoadingAPI.SearchPage.loadData,
    },
    {
      path: '/l',
